...
function ProjectCard({
  ...
  return (
    <div className="flex flex-col max-w-[500px] gap-4 p-4  bg-slate-900 border border-amber-400 rounded-md">
      <Image
        src={image}
        alt={title}
        width={500}
...
export default function Projects() {
  return (
    <div id="projectsList" className="grid grid-cols-1 md:grid-cols-2 gap-8">
